import { Scheduler, DateHelper, Rectangle, DomHelper, TabPanel, ArrayHelper, Popup, CSSHelper } from '../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    if (DomHelper.scrollBarWidth) {
        t.it('Should always use correct width to lay out ticks', async t => {
            ...
            // Just enough height to show no vertical scrollbar
            ...
            // Now a vertical scrollbar will be necessaty
            scheduler.height = 500;

            await t.waitForAnimationFrame();

            t.is(scheduler.timeAxisViewModel.availableSpace, 1024 - DomHelper.scrollBarWidth);

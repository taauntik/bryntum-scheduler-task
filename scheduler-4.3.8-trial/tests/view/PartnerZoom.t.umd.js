  ...
  t.it('Should sync zoom level', t => {
    ...
    function buildStep(zoomIn = true) {
      return [async () => {
        ...
        waitFor: () => Math.abs(topScheduler.scrollLeft - bottomScheduler.scrollLeft) < 1 && Math.abs(topScheduler.timeAxisViewModel.totalSize - bottomScheduler.timeAxisViewModel.totalSize) < 1,

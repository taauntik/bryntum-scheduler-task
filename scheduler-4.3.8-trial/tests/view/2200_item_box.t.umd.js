...
StartTest(t => {
  ...
  t.it("Scheduler view should report meaningfull item box even if it's not displayed, i.e. it should calculate item" + 'position based on dates, row number an item is, row height etc', async t => {

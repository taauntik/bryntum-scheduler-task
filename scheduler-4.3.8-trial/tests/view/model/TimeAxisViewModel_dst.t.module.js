import { TimeAxis, TimeAxisViewModel } from '../../../build/scheduler.module.js?456730';

StartTest(t => {
    // This test requires specific time zone to work
    if (
        new Date(2021, 9, 31).getTimezoneOffset() - new Date(2021, 9, 31, 12).getTimezoneOffset() === 0 ||
        new Date(2022, 9, 30).getTimezoneOffset() - new Date(2022, 9, 30, 12).getTimezoneOffset() === 0
    ) {
        return;
    }
    ...
    t.it('Should correctly create time axis when we render a single day from month (day and week)', t => {
        ...
        t.it('Start on long day, end on long day', t => {
            t.isApprox(
                ...
                tickSize / 24,
                1,
                'First tick width is approximately 1/24 of full tick size'
            );
            ...
            t.isApprox(
                ...
                tickSize / 24,
                1,
                'Last tick width is approximately 1/24 of full tick size'
            );
            ...
            t.isApprox(
                ...
                tickSize / 24 * 2,
                1,
                'First tick width is approximately 2/24 of full tick size'
            );
            ...
            t.isApprox(
                ...
                tickSize / 24 * 2,
                1,
                'Last tick width is approximately 2/24 of full tick size'
            );
        });

...
StartTest(t => {
  ...
  t.it('Should correctly create time axis when we render a single day from month (month and year)', t => {
    ...
    t.it('Start on long month, end on long month', t => {
      t.isApprox(model.getDistanceBetweenDates(timeAxis.first.startDate, timeAxis.first.endDate), tickSize / 30, 1, 'First tick width is approximately 1/30 of full tick size');
      t.isApprox(model.getDistanceBetweenDates(timeAxis.last.startDate, timeAxis.last.endDate), tickSize / 30, 1, 'Last tick width is approximately 1/30 of full tick size');
      timeAxis.setTimeSpan(new Date(2021, 7, 30), new Date(2021, 9, 3));
      t.isApprox(model.getDistanceBetweenDates(timeAxis.first.startDate, timeAxis.first.endDate), tickSize / 30 * 2, 1, 'First tick width is approximately 2/30 of full tick size');
      t.isApprox(model.getDistanceBetweenDates(timeAxis.last.startDate, timeAxis.last.endDate), tickSize / 30 * 2, 1, 'Last tick width is approximately 2/30 of full tick size');
    });
  ...
  t.it('Should correctly create time axis when we render a single day from leap year (day and year)', t => {
    ...
    t.it('Start/end on leap year', t => {
      t.isApprox(model.getDistanceBetweenDates(timeAxis.first.startDate, timeAxis.first.endDate), tickSize / 365, 1, 'First tick width is approximately 1/365 of full tick size');
      t.isApprox(model.getDistanceBetweenDates(timeAxis.last.startDate, timeAxis.last.endDate), tickSize / 365, 1, 'Last tick width is approximately 1/365 of full tick size');
      timeAxis.setTimeSpan(new Date(2020, 11, 30), new Date(2024, 0, 3));
      t.isApprox(model.getDistanceBetweenDates(timeAxis.first.startDate, timeAxis.first.endDate), tickSize / 365 * 2, 1, 'First tick width is approximately 2/365 of full tick size');
      t.isApprox(model.getDistanceBetweenDates(timeAxis.last.startDate, timeAxis.last.endDate), tickSize / 365 * 2, 1, 'Last tick width is approximately 2/365 of full tick size');
    });

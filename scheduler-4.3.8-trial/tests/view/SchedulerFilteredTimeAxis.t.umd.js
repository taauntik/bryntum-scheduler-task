...
StartTest(t => {
  ...
  t.beforeEach(t => scheduler && scheduler.destroy()); // Ported from 2112_filtered_time_axis
  ...
  t.it('View should return correct date for coordinate in filtered timeaxis', async t => {
    ...
    const tickSize = scheduler.timeAxisViewModel.tickSize,
          correctDate = new Date(2011, 2, 4); // now scheduler has splitter, append 4px to compensate it's width

...
StartTest(t => {
  ...
  t.it('Should format time correctly for all presets with time value', async t => {
    const viewPresetsWithTime = ['secondAndMinute', 'secondAndMinute-60by40', 'secondAndMinute-130by40', 'minuteAndHour', 'minuteAndHour-30by60', 'minuteAndHour-130by60', 'minuteAndHour-60by60', 'minuteAndHour-100by60', 'hourAndDay', 'hourAndDay-64by40', 'hourAndDay-100by40', 'hourAndDay-64by40-2', 'weekAndDay', 'weekAndDay-54by80', 'dayAndWeek'];
    scheduler = await t.getSchedulerAsync({

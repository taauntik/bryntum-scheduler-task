import { DomHelper, DependencyStore, Scheduler, ProjectModel, ArrayHelper } from '../../build/scheduler.module.js?456730';
            ...
            { waitForDependencies : null },
            {
                waitFor : () => {
                    ...
                    if (eventBox && dependencyEl) {
                        const
                            threshold = t.bowser.firefox ? 2 : 1,

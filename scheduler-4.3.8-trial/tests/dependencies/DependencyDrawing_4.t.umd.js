...
StartTest(t => {
  let scheduler, startVerticalMargin,
  /*startArrowMargin, */
  horizontalMargin;
  t.beforeEach(t => {
    if (scheduler) {
  ...
  async function getScheduler(config = {}) {
    ...
    ({
      /*startArrowMargin, */
      horizontalMargin
    } = scheduler.features.dependencies.pathFinder);
  }
  ...
  function convertPathToPoints(dependency, path) {
    const startSide = scheduler.features.dependencies.getDependencyStartSide(dependency),
  ...
  function walkDependency(t, dependencyOrId, path) {
    const dependency = dependencyOrId.isModel ? dependencyOrId : scheduler.dependencyStore.getById(dependencyOrId),
  ...
  t.it('in-row dependency lines are drawn correctly (from bottom)', async t => {
    ...
    function assertDependencies() {
      ...
      'u', 'r']);
      walkDependency(t, '1:1-2', [['d', startVerticalMargin], ['l', 20 * pxPerHour + endArrowMargin - delta], 'u', 'r']);
      walkDependency(t, '1:1-3', [['d', startVerticalMargin], ['l', 12 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-4', [['d', startVerticalMargin], ['l', endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-5', ['d', 'r']);
      walkDependency(t, '1:1-6', [['d', startVerticalMargin], ['r', 12 * pxPerHour + horizontalMargin - delta], 'u', 'r']);
    }
  ...
  t.it('in-row dependency lines are drawn correctly (from top)', async t => {
    ...
    function assertDependencies() {
      const pxPerHour = scheduler.timeAxisViewModel.getDistanceForDuration(1000 * 60 * 60),
            delta = 0.5;
      walkDependency(t, '1:1-1', [['u', startVerticalMargin], ['l', 32 * pxPerHour + endArrowMargin - delta], 'u', 'r']);
      walkDependency(t, '1:1-2', [['u', startVerticalMargin], ['l', 20 * pxPerHour + endArrowMargin - delta], 'u', 'r']);
      walkDependency(t, '1:1-3', [['u', startVerticalMargin], ['l', 12 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-4', [['u', startVerticalMargin], ['l', 12 * pxPerHour + horizontalMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-5', [['u', startVerticalMargin], ['l', 12 * pxPerHour + horizontalMargin - delta], 'd', 'r']);
  ...
  t.it('in-row dependency lines are drawn correctly (from right)', async t => {
    ...
    function assertDependencies() {
      const pxPerHour = scheduler.timeAxisViewModel.getDistanceForDuration(1000 * 60 * 60),
            ...
            delta = 1;
      walkDependency(t, '1:1-1', [['r', endArrowMargin], ['u', eventHeight / 2 + startVerticalMargin], ['l', 44 * pxPerHour + endArrowMargin * 2 - delta], 'u', 'r']);
      walkDependency(t, '1:1-2', [['r', endArrowMargin], ['u', eventHeight / 2 + startVerticalMargin], ['l', 32 * pxPerHour + endArrowMargin * 2 - delta], 'u', 'r']);
      walkDependency(t, '1:1-3', [['r', endArrowMargin], ['d', eventHeight / 2 + startVerticalMargin], ['l', 24 * pxPerHour + endArrowMargin * 2 - delta], 'd', 'r']);
      walkDependency(t, '1:1-4', [['r', endArrowMargin], ['d', eventHeight / 2 + startVerticalMargin], ['l', 12 * pxPerHour + endArrowMargin * 2 - delta], 'd', 'r']);
      walkDependency(t, '1:1-5', [['r', endArrowMargin], ['d', eventHeight / 2 + startVerticalMargin], ['l', 4 * pxPerHour + endArrowMargin * 2 - delta], 'd', 'r']);
  ...
  t.it('out-row dependency lines are drawn correctly (from right)', async t => {
    ...
    t.chain({
      ...
      walkDependency(t, '1:1-2', [['r', endArrowMargin], ['d', startVerticalMargin + eventHeight / 2], ['l', 24 * pxPerHour + endArrowMargin * 2 - 1], 'd', 'r']);
      ...
      ['d', startVerticalMargin * 4 + eventHeight * 1.5 + 1], ['l', 24 * pxPerHour + endArrowMargin * 2 - 1], 'd', 'r']);
    });
  });
    ...
    t.chain({
      ...
      const {
        endArrowMargin
            ...
            pxPerHour = scheduler.timeAxisViewModel.getDistanceForDuration(1000 * 60 * 60),
            delta = 0.5;
      walkDependency(t, '1:1-1', [['u', startVerticalMargin], ['l', 24 * pxPerHour + horizontalMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-2', [['u', startVerticalMargin], ['r', 48 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:2-1', [['u', startVerticalMargin * 2], ['l', 24 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:2-2', [['u', startVerticalMargin * 2], ['r', 48 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
    });
  });
    ...
    t.chain({
      ...
      const {
        endArrowMargin
            ...
            eventHeight = document.querySelector(scheduler.unreleasedEventSelector).offsetHeight,
            delta = 0.5;
      walkDependency(t, '1:1-1', [['d', startVerticalMargin], ['l', 20 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:1-2', [['d', startVerticalMargin], ['r', 48 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:2-1', [// two bar margins, full event, row border
      ['d', startVerticalMargin * 4 + eventHeight + 1], ['l', 20 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
      walkDependency(t, '1:2-2', [// two bar margins, full event, row border
      ['d', startVerticalMargin * 4 + eventHeight + 1], ['r', 48 * pxPerHour + endArrowMargin - delta], 'd', 'r']);
    });
  ...
  t.it('dependency lines are drawn correctly when scroll back with different row heights', async t => {
    ...
    const dependency = scheduler.dependencyStore.getById(2),
          dependencyEl = scheduler.getElementForDependency(dependency),
          points = dependencyEl.getAttribute('points');

import { ResourceStore, EventStore, AssignmentStore, ProjectModel } from '../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    t.it('Relation manipulations should work', async t => {
        ...
        t.is(batSneak.resourceId, 2, 'Assignments resourceId is 2');

import { BrowserHelper, Scheduler } from '../../build/scheduler.module.js?456730';
    ...
    t.it('Should track ResourceTimeRanges and TimeRanges', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            project : {
                ...
                timeRangesData : [
                    { id : 1, name : 'Range', startDate : '2011-01-05', endDate : '2011-01-07' }
                ],

                resourceTimeRangesData : [
                    { id : 1, name : 'Resource range', resourceId : 1, startDate : '2011-01-08', endDate : '2011-01-10' }
                ]
            }
        });

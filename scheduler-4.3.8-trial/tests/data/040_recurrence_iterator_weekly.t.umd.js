...
StartTest(t => {
  ...
  t.it('Weekly iterator handles weeks starting on not Sunday properly', async t => {
    ...
    const eventStore = new EventStore({
      data: [// Weekly in 2 weeks on Sun, Sat and Thu
      {
        id: 5,
        resourceId: 'r1',
    ...
    t.isDeeply(dates, [new Date(2021, 9, 7, 13, 30, 55), new Date(2021, 9, 9, 13, 30, 55), new Date(2021, 9, 10, 13, 30, 55), new Date(2021, 9, 21, 13, 30, 55), new Date(2021, 9, 23, 13, 30, 55), new Date(2021, 9, 24, 13, 30, 55)], 'proper dates iterated');

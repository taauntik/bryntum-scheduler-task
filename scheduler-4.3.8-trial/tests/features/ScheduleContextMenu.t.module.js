import { Scheduler, TimeAxisColumn, DateHelper, BrowserHelper, VersionHelper } from '../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    t.it('LEGACY: Should disable Add event if no resources exist', async t => {
        ...
        t.chain(
            { rightClick : '.b-grid-subgrid-normal', offset : [20, 20] },

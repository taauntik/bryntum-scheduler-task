import { DateHelper, DomHelper, Rectangle, Override, DataGenerator, RandomGenerator, PaperFormat, RowsRange, ScheduleRange, CSSHelper } from '../../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    t.it('Should export to multiple pages at the bottom of the short view', async t => {
        ...
        await scheduler.scrollRowIntoView(33, { block : 'start' });
        ...
        for (let i = 0; i < pages.length; i++) {
            ...
            t.isGreaterOrEqual(
                document.querySelectorAll('.b-timeline-subgrid .b-grid-row').length,
                scheduler.rowManager.visibleRowCount,
                'Correct amount of exported rows'
            );
    ...
    t.it('Should export to multiple pages at the bottom of the tall view', async t => {
        ...
        for (let i = 0; i < pages.length; i++) {
            ...
            const
                exportedRows = Array.from(document.querySelectorAll('.b-timeline-subgrid .b-grid-row')),

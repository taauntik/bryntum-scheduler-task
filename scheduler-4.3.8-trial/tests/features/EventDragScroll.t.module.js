StartTest(t => {
    ...
    t.it('Should scroll when dragging event (horizontal first)', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            width  : 300,
            events : [
                { id : 1, resourceId : 'r2', startDate : '2011-01-03', endDate : '2011-01-04' }
            ],
            features : {
                eventResize : false
            }
        ...
        const
            horizontalScrollable = scheduler.timeAxisSubGrid.scrollable.element,

import { DomHelper, Rectangle, DateHelper } from '../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    t.it('Content should be shifted on initial render', async t => {
        ...
        const
            { timeAxisSubGrid, scrollable } = scheduler,
    ...
    t.it('Should support opt out of stickiness for individual events', async t => {
        ...
        t.isLess(t.rect('.b-sch-event-content').left,
    ...
    t.it('Should support disabling stickiness', async t => {
        ...
        t.isGreaterOrEqual(t.rect('.b-sch-event-content').left,
            scheduler.timeAxisSubGridElement.getBoundingClientRect().left, 'Event content in view');
    });

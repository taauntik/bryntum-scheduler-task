import { AbstractCrudManager, Store, CrudManager, JsonEncoder, ResourceModel, EventModel, ProjectModel } from '../../build/scheduler.module.js?456730';
...
StartTest(t => {
    ...
    t.it('Should support suspendAutoSync/resumeAutoSync', async t => {
        ...
        t.mockUrl('short-sync', { responseText : '{}' });

        const spy = t.spyOn(crud, 'sync');

        // make event store dirty to guarantee sync() is called

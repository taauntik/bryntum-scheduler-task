...
<script>
import VuesticFileUploadListItem from './VuesticFileUploadListItem.vue'
import VuesticFileUploadGalleryItem from './VuesticFileUploadGalleryItem.vue'
import VuesticFileUploadSingleItem from './VuesticFileUploadSingleItem.vue'

# Vue Scheduler With Custom Editor

This example uses Bryntum Scheduler wrapped in the provided `BryntumSchedulerComponent` wrapper.
This demo contains an example of the Vue Scheduler with a custom Vue based event editor popup replacing the default one.

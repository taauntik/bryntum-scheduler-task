...
class MyTimeRange extends RecurringTimeSpan(TimeSpan) {} // Define a new store extending the Store class
...
const myTimeRangeStore = new MyTimeRangeStore(); //endregion

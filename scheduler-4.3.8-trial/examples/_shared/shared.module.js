import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle, TrialButton, Base, Menu } from '../../build/scheduler.module.js?456730';
import '../_shared/product.module.js?456730';
/* global RC */
// Load product config
...
const
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag?.src.includes('app.module.js?456730')) || (pathName.endsWith('index.html') && isBryntumCom),
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?456730' : isUmd ? 'app.umd.js?456730' : 'app.js?456730',
                    items    : [
                        isModule ? 'app.module.js?456730' : isUmd ? 'app.umd.js?456730' : 'app.js?456730'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?456730' : isUmd ? 'app.umd.js?456730' : 'app.js?456730') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?456730')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?456730')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?456730') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?456730"]')) {
            filesStore.add({
                text  : 'resources/app.css?456730',
                value : 'resources/app.css?456730'
            });
        }
